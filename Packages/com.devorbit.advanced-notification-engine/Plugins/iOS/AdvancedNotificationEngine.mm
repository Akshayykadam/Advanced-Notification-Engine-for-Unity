...
// This header is auto-generated by Xcode when it compiles the .swift file.
// Your IDE may show "file not found" — this is normal and only resolves during the actual Xcode build.
